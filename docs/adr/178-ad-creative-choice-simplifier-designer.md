# ADR-178: Choice Simplifier Designer
...
Simplifies complex product choices for audiences using decision-heuristics. This capability
...
Implement `ad-creative-choice-simplifier-designer` as a creative library in `src/lib/creative/ad-creative-choice-simplifier-designer.ts`
that:
...
- Exposes API routes under `/api/creative/ad-creative-choice-simplifier-designer`

### API

- `GET /api/creative/ad-creative-choice-simplifier-designer` — returns credit cost and schema
- `POST /api/creative/ad-creative-choice-simplifier-designer` — executes the choice simplifier designer
...
- Covered by unit tests in `test/ad-creative-choice-simplifier-designer.test.ts`
