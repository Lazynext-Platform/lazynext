# ADR-184: Unique Mechanism Designer
...
Identifies and articulates the unique mechanism that makes a product effective. This capability
...
Implement `ad-creative-unique-mechanism-designer` as a creative library in `src/lib/creative/ad-creative-unique-mechanism-designer.ts`
that:
...
- Exposes API routes under `/api/creative/ad-creative-unique-mechanism-designer`

### API

- `GET /api/creative/ad-creative-unique-mechanism-designer` — returns credit cost and schema
- `POST /api/creative/ad-creative-unique-mechanism-designer` — executes the unique mechanism designer
...
- Covered by unit tests in `test/ad-creative-unique-mechanism-designer.test.ts`
