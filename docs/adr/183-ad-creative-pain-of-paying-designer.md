# ADR-183: Pain of Paying Designer
...
Reduces the psychological pain of paying through strategic framing. This capability
...
Implement `ad-creative-pain-of-paying-designer` as a creative library in `src/lib/creative/ad-creative-pain-of-paying-designer.ts`
that:
...
- Exposes API routes under `/api/creative/ad-creative-pain-of-paying-designer`

### API

- `GET /api/creative/ad-creative-pain-of-paying-designer` — returns credit cost and schema
- `POST /api/creative/ad-creative-pain-of-paying-designer` — executes the pain of paying designer
...
- Covered by unit tests in `test/ad-creative-pain-of-paying-designer.test.ts`
