...
/**
 * E2E smoke tests for the ad caption generator page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('ad caption generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-caption-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-caption-generator');
    await expect(page).toHaveURL(/\/ad-caption-generator/);
  });
