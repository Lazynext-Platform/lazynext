...
test.describe('Ad Creative Curiosity Loop Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-curiosity-loop-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-curiosity-loop-designer');
    await expect(page).toHaveURL(/\/ad-creative-curiosity-loop-designer/);
  });
