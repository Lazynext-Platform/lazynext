...
test.describe('creative-ad-pattern-interrupt-designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-pattern-interrupt-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-pattern-interrupt-designer');
    await expect(page).toHaveURL(/\/creative-ad-pattern-interrupt-designer/);
  });
