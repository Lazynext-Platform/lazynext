...
test.describe('Creative Ad Transformation Arc Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-transformation-arc-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-transformation-arc-designer');
    await expect(page).toHaveURL(/\/creative-ad-transformation-arc-designer/);
  });
