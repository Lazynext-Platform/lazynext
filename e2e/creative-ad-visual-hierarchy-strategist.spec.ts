...
test.describe('creative-ad-visual-hierarchy-strategist Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-visual-hierarchy-strategist');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-visual-hierarchy-strategist');
    await expect(page).toHaveURL(/\/creative-ad-visual-hierarchy-strategist/);
  });
