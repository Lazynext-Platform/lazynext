...
test.describe('creative-ad-micro-moment-designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-micro-moment-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-micro-moment-designer');
    await expect(page).toHaveURL(/\/creative-ad-micro-moment-designer/);
  });
