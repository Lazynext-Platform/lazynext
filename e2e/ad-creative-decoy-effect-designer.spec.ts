...
test.describe('Ad Creative Decoy Effect Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-decoy-effect-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-decoy-effect-designer');
    await expect(page).toHaveURL(/\/ad-creative-decoy-effect-designer/);
  });
