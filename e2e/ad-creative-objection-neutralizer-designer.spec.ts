...
test.describe('Ad Creative Objection Neutralizer Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-objection-neutralizer-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-objection-neutralizer-designer');
    await expect(page).toHaveURL(/\/ad-creative-objection-neutralizer-designer/);
  });
