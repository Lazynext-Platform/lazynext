...
test.describe('creative-ad-resolution-designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-resolution-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-resolution-designer');
    await expect(page).toHaveURL(/\/creative-ad-resolution-designer/);
  });
