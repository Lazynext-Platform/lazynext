...
test.describe('Ad Creative Pride Appeal Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-pride-appeal-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-pride-appeal-designer');
    await expect(page).toHaveURL(/\/ad-creative-pride-appeal-designer/);
  });
