...
/**
 * E2E smoke tests for the ad-thumbnail-generator page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('ad-thumbnail-generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-thumbnail-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-thumbnail-generator');
    await expect(page).toHaveURL(/\/ad-thumbnail-generator/);
  });
