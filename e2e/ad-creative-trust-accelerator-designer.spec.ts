...
test.describe('Ad Creative Trust Accelerator Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-trust-accelerator-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-trust-accelerator-designer');
    await expect(page).toHaveURL(/\/ad-creative-trust-accelerator-designer/);
  });
