...
test.describe('ad-creative-hook-timing-optimizer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-hook-timing-optimizer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-hook-timing-optimizer');
    await expect(page).toHaveURL(/\/ad-creative-hook-timing-optimizer/);
  });
