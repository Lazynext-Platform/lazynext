...
/**
 * E2E smoke tests for the ad headline generator page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('ad headline generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-headline-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-headline-generator');
    await expect(page).toHaveURL(/\/ad-headline-generator/);
  });
