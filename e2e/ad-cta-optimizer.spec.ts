...
/**
 * E2E smoke tests for the ad CTA optimizer page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('ad CTA optimizer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-cta-optimizer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-cta-optimizer');
    await expect(page).toHaveURL(/\/ad-cta-optimizer/);
  });
