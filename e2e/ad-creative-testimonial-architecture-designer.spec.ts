...
test.describe('Ad Creative Testimonial Architecture Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-testimonial-architecture-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-testimonial-architecture-designer');
    await expect(page).toHaveURL(/\/ad-creative-testimonial-architecture-designer/);
  });
