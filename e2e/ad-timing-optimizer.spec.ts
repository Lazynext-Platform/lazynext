...
/**
 * E2E smoke tests for the ad timing optimizer page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('ad timing optimizer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-timing-optimizer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-timing-optimizer');
    await expect(page).toHaveURL(/\/ad-timing-optimizer/);
  });
