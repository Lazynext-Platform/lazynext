...
test.describe('creative-hook-revamp-generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-hook-revamp-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-hook-revamp-generator');
    await expect(page).toHaveURL(/\/creative-hook-revamp-generator/);
  });
