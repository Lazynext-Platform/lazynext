...
test.describe('Creative Ad Stakes Escalation Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-stakes-escalation-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-stakes-escalation-designer');
    await expect(page).toHaveURL(/\/creative-ad-stakes-escalation-designer/);
  });
