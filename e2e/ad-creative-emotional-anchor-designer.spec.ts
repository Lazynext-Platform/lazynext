...
test.describe('Ad Creative Emotional Anchor Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-emotional-anchor-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-emotional-anchor-designer');
    await expect(page).toHaveURL(/\/ad-creative-emotional-anchor-designer/);
  });
