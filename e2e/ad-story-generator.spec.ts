...
/**
 * E2E smoke tests for the ad story generator page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('ad story generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-story-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-story-generator');
    await expect(page).toHaveURL(/\/ad-story-generator/);
  });
