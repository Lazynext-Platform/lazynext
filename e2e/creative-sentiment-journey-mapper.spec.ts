...
test.describe('creative-sentiment-journey-mapper Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-sentiment-journey-mapper');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-sentiment-journey-mapper');
    await expect(page).toHaveURL(/\/creative-sentiment-journey-mapper/);
  });
