...
/**
 * E2E smoke tests for the creative-brief-generator page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('creative-brief-generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-brief-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-brief-generator');
    await expect(page).toHaveURL(/\/creative-brief-generator/);
  });
