...
test.describe('ad-creative-social-proof-architect Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-social-proof-architect');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-social-proof-architect');
    await expect(page).toHaveURL(/\/ad-creative-social-proof-architect/);
  });
