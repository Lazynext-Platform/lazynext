...
test.describe('Ad Creative Scarcity Frame Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-scarcity-frame-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-scarcity-frame-designer');
    await expect(page).toHaveURL(/\/ad-creative-scarcity-frame-designer/);
  });
