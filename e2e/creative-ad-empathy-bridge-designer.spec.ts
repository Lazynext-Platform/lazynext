...
test.describe('Creative Ad Empathy Bridge Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-empathy-bridge-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-empathy-bridge-designer');
    await expect(page).toHaveURL(/\/creative-ad-empathy-bridge-designer/);
  });
