...
test.describe('ad-creative-lifecycle-manager Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-lifecycle-manager');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-lifecycle-manager');
    await expect(page).toHaveURL(/\/ad-creative-lifecycle-manager/);
  });
