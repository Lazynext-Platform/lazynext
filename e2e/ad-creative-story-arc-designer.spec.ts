...
test.describe('ad-creative-story-arc-designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-story-arc-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-story-arc-designer');
    await expect(page).toHaveURL(/\/ad-creative-story-arc-designer/);
  });
