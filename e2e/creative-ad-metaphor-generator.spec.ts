...
test.describe('creative-ad-metaphor-generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-metaphor-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-metaphor-generator');
    await expect(page).toHaveURL(/\/creative-ad-metaphor-generator/);
  });
