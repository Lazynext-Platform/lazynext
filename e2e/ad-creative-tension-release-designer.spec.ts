...
test.describe('Ad Creative Tension Release Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-tension-release-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-tension-release-designer');
    await expect(page).toHaveURL(/\/ad-creative-tension-release-designer/);
  });
