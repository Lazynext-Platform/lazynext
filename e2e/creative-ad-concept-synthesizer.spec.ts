...
test.describe('creative-ad-concept-synthesizer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-concept-synthesizer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-concept-synthesizer');
    await expect(page).toHaveURL(/\/creative-ad-concept-synthesizer/);
  });
