...
/**
 * E2E smoke tests for the creative-scene-generator page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('creative-scene-generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-scene-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-scene-generator');
    await expect(page).toHaveURL(/\/creative-scene-generator/);
  });
