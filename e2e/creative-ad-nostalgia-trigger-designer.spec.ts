...
test.describe('Creative Ad Nostalgia Trigger Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-nostalgia-trigger-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-nostalgia-trigger-designer');
    await expect(page).toHaveURL(/\/creative-ad-nostalgia-trigger-designer/);
  });
