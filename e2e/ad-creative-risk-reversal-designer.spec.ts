...
test.describe('Ad Creative Risk Reversal Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-risk-reversal-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-risk-reversal-designer');
    await expect(page).toHaveURL(/\/ad-creative-risk-reversal-designer/);
  });
