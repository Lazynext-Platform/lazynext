...
test.describe('Ad Creative Demonstration Framework Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-demonstration-framework-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-demonstration-framework-designer');
    await expect(page).toHaveURL(/\/ad-creative-demonstration-framework-designer/);
  });
