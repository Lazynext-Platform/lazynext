...
test.describe('creative-ad-anticipation-builder Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-anticipation-builder');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-anticipation-builder');
    await expect(page).toHaveURL(/\/creative-ad-anticipation-builder/);
  });
