...
test.describe('Creative Ad Belonging Appeal Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-belonging-appeal-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-belonging-appeal-designer');
    await expect(page).toHaveURL(/\/creative-ad-belonging-appeal-designer/);
  });
