...
test.describe('Ad Creative Fear Appeal Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-fear-appeal-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-fear-appeal-designer');
    await expect(page).toHaveURL(/\/ad-creative-fear-appeal-designer/);
  });
