...
test.describe('Creative Ad Fab Framework Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-fab-framework-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-fab-framework-designer');
    await expect(page).toHaveURL(/\/creative-ad-fab-framework-designer/);
  });
