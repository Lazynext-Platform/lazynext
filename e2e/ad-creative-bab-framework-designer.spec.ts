...
test.describe('Ad Creative Bab Framework Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-bab-framework-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-bab-framework-designer');
    await expect(page).toHaveURL(/\/ad-creative-bab-framework-designer/);
  });
