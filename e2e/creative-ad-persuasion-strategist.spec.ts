...
test.describe('creative-ad-persuasion-strategist Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-persuasion-strategist');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-persuasion-strategist');
    await expect(page).toHaveURL(/\/creative-ad-persuasion-strategist/);
  });
