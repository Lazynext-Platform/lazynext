...
test.describe('Creative Ad Endowment Effect Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-endowment-effect-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-endowment-effect-designer');
    await expect(page).toHaveURL(/\/creative-ad-endowment-effect-designer/);
  });
