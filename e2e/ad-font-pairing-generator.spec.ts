...
/**
 * E2E smoke tests for the ad-font-pairing-generator page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('ad-font-pairing-generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-font-pairing-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-font-pairing-generator');
    await expect(page).toHaveURL(/\/ad-font-pairing-generator/);
  });
