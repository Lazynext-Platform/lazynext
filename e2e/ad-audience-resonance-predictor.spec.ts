...
test.describe('ad-audience-resonance-predictor Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-audience-resonance-predictor');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-audience-resonance-predictor');
    await expect(page).toHaveURL(/\/ad-audience-resonance-predictor/);
  });
