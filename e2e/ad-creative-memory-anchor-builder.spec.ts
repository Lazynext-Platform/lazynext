...
test.describe('ad-creative-memory-anchor-builder Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-memory-anchor-builder');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-memory-anchor-builder');
    await expect(page).toHaveURL(/\/ad-creative-memory-anchor-builder/);
  });
