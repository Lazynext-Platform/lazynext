...
/**
 * E2E smoke tests for the ad-hashtag-generator page.
 * Auth-gated page — shows AuthModal when unauthenticated.
 */

test.describe('ad-hashtag-generator Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-hashtag-generator');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-hashtag-generator');
    await expect(page).toHaveURL(/\/ad-hashtag-generator/);
  });
