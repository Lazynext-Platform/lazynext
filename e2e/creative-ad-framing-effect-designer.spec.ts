...
test.describe('Creative Ad Framing Effect Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-framing-effect-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-framing-effect-designer');
    await expect(page).toHaveURL(/\/creative-ad-framing-effect-designer/);
  });
