...
test.describe('Creative Ad Micro-Commitment Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/creative-ad-micro-commitment-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/creative-ad-micro-commitment-designer');
    await expect(page).toHaveURL(/\/creative-ad-micro-commitment-designer/);
  });
