...
test.describe('ad-creative-emotion-sequencer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-emotion-sequencer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-emotion-sequencer');
    await expect(page).toHaveURL(/\/ad-creative-emotion-sequencer/);
  });
