...
test.describe('Ad Creative Anchoring Effect Designer Page', () => {
  test('loads with correct title', async ({ page }) => {
    await page.goto('/ad-creative-anchoring-effect-designer');
  ...
  test('is reachable via direct navigation', async ({ page }) => {
    await page.goto('/ad-creative-anchoring-effect-designer');
    await expect(page).toHaveURL(/\/ad-creative-anchoring-effect-designer/);
  });
