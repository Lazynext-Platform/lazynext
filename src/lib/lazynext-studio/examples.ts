// Preview videos for format cards (format id → same-origin static resource url).
// Generated by multiref-demo/gen_examples.py → transferred to R2, and also saved to public/examples/marketing/ex-<id>.mp4,
// making the repo self-contained: clone/local deploy can see the showcase without connecting to R2.
...
// ── One-click replica recipes (aligned with Higgsfield: product image @product + person image @avatar dual reference + a long detailed prompt) ──
// Image generation: nano-banana/edit uses [person image + product image] dual reference to composite a "this person holding this product selfie" first frame (face/product both pixel-level preserved);
// Video generation: veo3.1-fast + detailed action/long dialogue → lip-synced speech. Tested and working in multiref-demo/repl_test2.py.
// image = product image, avatar = person image (only for UGC voiceover types; empty for no-person formats). Users can replace with their own product image/on-screen person after replicating.
export interface ExampleRecipe {
  productZh: string;
  productEn: string;
  image: string;        // product reference image
  avatar?: string;      // person reference image (UGC voiceover types only)
  imgPrompt: string;    // nano-banana/edit first frame prompt
  vidPrompt: string;    // veo3.1-fast i2v prompt (detailed scene + action + dialogue)
}
...
// Dual-image selfie first frame template: person (portrait ref) holding product (product ref)
...
// Detailed voiceover video template: selfie shooting + product action + dialogue
...
export const EXAMPLE_RECIPES: Record<string, ExampleRecipe> = {
  ugc: {
    ...
    image: '/api/lazynext-studio/media/prod-ugc.jpg', avatar: '/api/lazynext-studio/media/avatar-ugc.jpg',
  ...
  'direct-to-camera': {
    ...
    image: '/api/lazynext-studio/media/prod-direct-to-camera.jpg', avatar: '/api/lazynext-studio/media/avatar-direct-to-camera.jpg',
  ...
  'selfie-testimonial': {
    ...
    image: '/api/lazynext-studio/media/prod-selfie-testimonial.jpg', avatar: '/api/lazynext-studio/media/avatar-selfie-testimonial.jpg',
  ...
  'gadget-saved-me': {
    ...
    image: '/api/lazynext-studio/media/prod-gadget-saved-me.jpg', avatar: '/api/lazynext-studio/media/avatar-gadget-saved-me.jpg',
  ...
  'secret-hack': {
    ...
    image: '/api/lazynext-studio/media/prod-secret-hack.jpg', avatar: '/api/lazynext-studio/media/avatar-secret-hack.jpg',
  ...
  review: {
    ...
    image: '/api/lazynext-studio/media/prod-review.jpg', avatar: '/api/lazynext-studio/media/avatar-review.jpg',
  ...
  unboxing: {
    ...
    image: '/api/lazynext-studio/media/prod-unboxing.jpg', avatar: '/api/lazynext-studio/media/avatar-unboxing.jpg',
  ...
  'try-on': {
    ...
    image: '/api/lazynext-studio/media/prod-try-on.jpg', avatar: '/api/lazynext-studio/media/avatar-try-on.jpg',
  ...
  'crush-test': {
    ...
    image: '/api/lazynext-studio/media/prod-crush-test.jpg', avatar: '/api/lazynext-studio/media/avatar-crush-test.jpg',
  ...
  'couple-sharing': {
    ...
    image: '/api/lazynext-studio/media/prod-couple-sharing.jpg',
  ...
  'unboxing-asmr': {
    ...
    image: '/api/lazynext-studio/media/prod-unboxing-asmr.jpg',
  ...
  tvspot: {
    ...
    image: '/api/lazynext-studio/media/prod-tvspot.jpg',
  ...
  hypermotion: {
    ...
    image: '/api/lazynext-studio/media/prod-hypermotion.jpg',
  ...
  'giant-product': {
    ...
    image: '/api/lazynext-studio/media/prod-giant-product.jpg',
  ...
  'camera-pov': {
    ...
    image: '/api/lazynext-studio/media/prod-camera-pov.jpg',
  ...
  'mess-to-fresh': {
    ...
    image: '/api/lazynext-studio/media/prod-mess-to-fresh.jpg',
