...
/** GET /api/compliance-audit/compliance-score — get compliance score */
export async function GET(req: NextRequest) {
  ...
  const score = await ComplianceAuditService.getComplianceScore(organizationId, frameworkId ? { frameworkId } : {});
