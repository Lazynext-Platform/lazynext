            ...
            {creatives.map((c, i) => (
              <div key={i} className="rounded-lg border border-border bg-bg-card p-3 space-y-2">
                <div className="flex items-center gap-2">
                  <input type="text" placeholder="Creative name" value={c.creativeName} onChange={(e) => updateCreative(i, 'creativeName', e.target.value)} className="flex-1 rounded-lg border border-border bg-bg-secondary px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                ...
                <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                  <input type="number" placeholder="Freq" value={c.currentFrequency} onChange={(e) => updateCreative(i, 'currentFrequency', e.target.value)} className="rounded border border-border bg-bg-secondary px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                  <input type="number" placeholder="CTR%" value={c.currentCtr} onChange={(e) => updateCreative(i, 'currentCtr', e.target.value)} className="rounded border border-border bg-bg-secondary px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                  <input type="number" placeholder="CVR%" value={c.currentCvr} onChange={(e) => updateCreative(i, 'currentCvr', e.target.value)} className="rounded border border-border bg-bg-secondary px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                  <input type="number" placeholder="Eng%" value={c.currentEngagementRate} onChange={(e) => updateCreative(i, 'currentEngagementRate', e.target.value)} className="rounded border border-border bg-bg-secondary px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                  <input type="number" placeholder="ROAS" value={c.currentRoas} onChange={(e) => updateCreative(i, 'currentRoas', e.target.value)} className="rounded border border-border bg-bg-secondary px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                  <input type="number" placeholder="CPM" value={c.currentCpm} onChange={(e) => updateCreative(i, 'currentCpm', e.target.value)} className="rounded border border-border bg-bg-secondary px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                </div>
                <div className="grid grid-cols-3 gap-2">
                  <input type="number" placeholder="Days running" value={c.daysRunning} onChange={(e) => updateCreative(i, 'daysRunning', e.target.value)} className="rounded border border-border bg-bg-secondary px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                  <input type="number" placeholder="Total impressions" value={c.totalImpressions} onChange={(e) => updateCreative(i, 'totalImpressions', e.target.value)} className="rounded border border-border bg-bg-secondary px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                  <input type="number" placeholder="Total spend" value={c.totalSpend} onChange={(e) => updateCreative(i, 'totalSpend', e.target.value)} className="rounded border border-border bg-bg-secondary px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                </div>
              </div>
            ))}
