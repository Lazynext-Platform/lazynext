...
const NAV_LINKS = [
  ...
  { href: '/creative-ad-foreshadowing-designer', label: 'Foreshadowing Designer', icon: Eye, hideOnMd: true },
  ...
  { href: '/ad-creative-emotional-anchor-designer', label: 'Emotional Anchor Designer', icon: Anchor, hideOnMd: true },
