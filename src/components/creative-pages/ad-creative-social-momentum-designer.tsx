        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={t('adCreativeSocialMomentumDesigner.audiencePh')}
              rows={4}
              maxLength={2000}
          ...
          >
            ...
            {loading ? t('adCreativeSocialMomentumDesigner.generating') : `${t('adCreativeSocialMomentumDesigner.generate')} (${CREDIT_COST} ${t('common.creditsLower')})`}
          </button>
        </div>
