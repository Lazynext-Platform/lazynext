        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder={t('creativeAdMetaphorGenerator.benefitPh')}
              maxLength={2000}
              className="w-full rounded-lg border border-border bg-bg-card px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent"
              disabled={loading}
            />
          ...
          <div>
            ...
            <input
              ...
              placeholder={t('common.phAudienceConcern')}
              maxLength={2000}
              className="w-full rounded-lg border border-border bg-bg-card px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent"
              disabled={loading}
            />
          ...
          >
            ...
            {loading ? t('creativeAdMetaphorGenerator.generating') : `${t('creativeAdMetaphorGenerator.generate')} (${CREDIT_COST} ${t('common.creditsLower')})`}
          </button>
        </div>
