          ...
          <div className="space-y-2">
            {rows.map((r, i) => (
              <div key={i} className="grid grid-cols-2 sm:grid-cols-7 gap-2 items-end">
                ...
                <input type="number" placeholder="Spend" value={r.spend} onChange={(e) => updateRow(i, 'spend', e.target.value)} className="rounded-lg border border-border bg-bg-card px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                <input type="number" placeholder="Impr." value={r.impressions} onChange={(e) => updateRow(i, 'impressions', e.target.value)} className="rounded-lg border border-border bg-bg-card px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                <input type="number" placeholder="Clicks" value={r.clicks} onChange={(e) => updateRow(i, 'clicks', e.target.value)} className="rounded-lg border border-border bg-bg-card px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                <input type="number" placeholder="Conv." value={r.conversions} onChange={(e) => updateRow(i, 'conversions', e.target.value)} className="rounded-lg border border-border bg-bg-card px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
                <input type="number" placeholder="Rev." value={r.revenue} onChange={(e) => updateRow(i, 'revenue', e.target.value)} className="rounded-lg border border-border bg-bg-card px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent" disabled={loading} />
