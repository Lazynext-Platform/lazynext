...
const CUSTOM_TITLES: Record<string, Bi> = {
  ...
  'ad-creative-pas-framework-designer': { en: 'Ad Creative PAS Framework Designer', zh: '广告创意PAS框架设计师' },
  'creative-ad-offer-architecture-designer': { en: 'Creative Ad Offer Architecture Designer', zh: '创意广告报价架构设计师' },
  'ad-creative-bab-framework-designer': { en: 'Ad Creative BAB Framework Designer', zh: '广告创意BAB框架设计师' },
  'creative-ad-price-framing-designer': { en: 'Creative Ad Price Framing Designer', zh: '创意广告价格框架设计师' },
  'ad-creative-risk-reversal-designer': { en: 'Ad Creative Risk Reversal Designer', zh: '广告创意风险逆转设计师' },
  'ad-creative-testimonial-architecture-designer': { en: 'Ad Creative Testimonial Architecture Designer', zh: '广告创意证言架构设计师' },
  'ad-creative-authority-positioning-designer': { en: 'Ad Creative Authority Positioning Designer', zh: '广告创意权威定位设计师' },
  'creative-ad-liking-affinity-designer': { en: 'Creative Ad Liking Affinity Designer', zh: '创意广告好感亲和力设计师' },
  'ad-creative-fear-appeal-designer': { en: 'Ad Creative Fear Appeal Designer', zh: '广告创意恐惧诉求设计师' },
  'creative-ad-belonging-appeal-designer': { en: 'Creative Ad Belonging Appeal Designer', zh: '创意广告归属感诉求设计师' },
  'ad-creative-humor-appeal-designer': { en: 'Ad Creative Humor Appeal Designer', zh: '广告创意幽默诉求设计师' },
  'creative-ad-framing-effect-designer': { en: 'Creative Ad Framing Effect Designer', zh: '创意广告框架效应设计师' },
  'ad-creative-pride-appeal-designer': { en: 'Ad Creative Pride Appeal Designer', zh: '广告创意自豪感诉求设计师' },
  'creative-ad-nostalgia-trigger-designer': { en: 'Creative Ad Nostalgia Trigger Designer', zh: '创意广告怀旧触发器设计师' },
  'ad-creative-decoy-effect-designer': { en: 'Ad Creative Decoy Effect Designer', zh: '广告创意诱饵效应设计师' },
  'creative-ad-endowment-effect-designer': { en: 'Creative Ad Endowment Effect Designer', zh: '创意广告禀赋效应设计师' },
  'creative-ad-fab-framework-designer': { en: 'Creative Ad FAB Framework Designer', zh: '创意广告FAB框架设计师' },
  'creative-ad-comparison-framework-designer': { en: 'Creative Ad Comparison Framework Designer', zh: '创意广告对比框架设计师' },
  'ad-creative-demonstration-framework-designer': { en: 'Ad Creative Demonstration Framework Designer', zh: '广告创意演示框架设计师' },
