        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="e.g., Originally $199, now just $89 for our vitamin C serum..."
              rows={4}
              maxLength={2000}
          ...
          >
            ...
            {loading ? t('adCreativeAnchoringEffectDesigner.generating') : `${t('adCreativeAnchoringEffectDesigner.generate')} (${CREDIT_COST} credits)`}
          </button>
        </div>
