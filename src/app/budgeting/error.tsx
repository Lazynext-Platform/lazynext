  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="rounded-lg border border-fg-danger/30 bg-fg-danger/5 p-6">
        <h2 className="text-sm font-medium text-fg-danger mb-2">Failed to load budgeting dashboard</h2>
        <p className="text-xs text-fg-secondary mb-4">An error occurred while loading your budget data.</p>
