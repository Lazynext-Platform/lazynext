        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={t('creativeAdLossAversionFramingDesigner.contentPh')}
              rows={4}
              maxLength={2000}
          ...
          >
            ...
            {loading ? t('creativeAdLossAversionFramingDesigner.generating') : `${t('creativeAdLossAversionFramingDesigner.generate')} (${CREDIT_COST} ${t('common.creditsLower')})`}
          </button>
        </div>
