 ...
 * Catch-all route handler for /api/traces/*
 * Consolidates 4 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as stats from '@/lib/api-handlers/traces/stats';
import * as index from '@/lib/api-handlers/traces/index';
import * as _id__spans from '@/lib/api-handlers/traces/_id__spans';
import * as _id from '@/lib/api-handlers/traces/_id';
...
const routeTable: RouteEntry[] = [
  ...
  { segments: ["[id]","spans"], paramNames: ["id"], handlers: { POST: _id__spans.POST } },
  { segments: ["[id]"], paramNames: ["id"], handlers: { GET: _id.GET } },
];
