 ...
 * Catch-all route handler for /api/agent-roles/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as index from '@/lib/api-handlers/agent-roles/index';
import * as _role from '@/lib/api-handlers/agent-roles/_role';
...
const routes: RouteEntry[] = [
  ...
  { segments: ["[role]"], paramNames: ["role"], handlers: { GET: _role.GET } },
];
