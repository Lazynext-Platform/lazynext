 ...
 * Catch-all route handler for /api/keys/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as index from '@/lib/api-handlers/keys/index';
import * as _id from '@/lib/api-handlers/keys/_id';
...
const routeTable: RouteEntry[] = [
  ...
  { segments: ["[id]"], paramNames: ["id"], handlers: { DELETE: _id.DELETE } },
];
