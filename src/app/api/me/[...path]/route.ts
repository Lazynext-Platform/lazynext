 ...
 * Catch-all route handler for /api/me/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as preferences from '@/lib/api-handlers/me/preferences';
import * as index from '@/lib/api-handlers/me/index';
...
const routeTable: RouteEntry[] = [
  { segments: ["preferences"], paramNames: [], handlers: { GET: preferences.GET, POST: preferences.POST } },
