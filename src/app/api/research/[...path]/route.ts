 ...
 * Catch-all route handler for /api/research/*
 * Consolidates 3 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as sessions from '@/lib/api-handlers/research/sessions';
import * as sessions___id__citations from '@/lib/api-handlers/research/sessions___id__citations';
import * as sessions___id from '@/lib/api-handlers/research/sessions___id';
...
const routes: RouteEntry[] = [
  ...
  { segments: ["sessions","[id]","citations"], paramNames: ["id"], handlers: { GET: sessions___id__citations.GET, POST: sessions___id__citations.POST } },
