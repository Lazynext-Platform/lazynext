 ...
 * Catch-all route handler for /api/approvals/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as index from '@/lib/api-handlers/approvals/index';
import * as _id from '@/lib/api-handlers/approvals/_id';
...
const routes: RouteEntry[] = [
  ...
  { segments: ["[id]"], paramNames: ["id"], handlers: { GET: _id.GET, POST: _id.POST } },
];
