 ...
 * Catch-all route handler for /api/brand/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as extract from '@/lib/api-handlers/brand/extract';
import * as product_extract from '@/lib/api-handlers/brand/product_extract';
...
const routes: RouteEntry[] = [
  { segments: ["extract"], paramNames: [], handlers: { POST: extract.POST } },
  { segments: ["product-extract"], paramNames: [], handlers: { POST: product_extract.POST } },
];
