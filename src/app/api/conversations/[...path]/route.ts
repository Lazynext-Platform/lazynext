 ...
 * Catch-all route handler for /api/conversations/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as index from '@/lib/api-handlers/conversations/index';
import * as _id__messages from '@/lib/api-handlers/conversations/_id__messages';
...
const routeTable: RouteEntry[] = [
  ...
  { segments: ["[id]","messages"], paramNames: ["id"], handlers: { GET: _id__messages.GET, POST: _id__messages.POST } },
];
