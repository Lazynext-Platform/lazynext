 ...
 * Catch-all route handler for /api/integration-health/*
 * Consolidates 4 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as check from '@/lib/api-handlers/integration-health/check';
import * as check_all from '@/lib/api-handlers/integration-health/check_all';
import * as degraded from '@/lib/api-handlers/integration-health/degraded';
import * as summary from '@/lib/api-handlers/integration-health/summary';
...
const routes: RouteEntry[] = [
  { segments: ["check"], paramNames: [], handlers: { POST: check.POST } },
  { segments: ["check-all"], paramNames: [], handlers: { POST: check_all.POST } },
  { segments: ["degraded"], paramNames: [], handlers: { GET: degraded.GET } },
