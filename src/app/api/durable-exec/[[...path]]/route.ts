 ...
 * Catch-all route handler for /api/durable-exec/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as process from '@/lib/api-handlers/durable-exec/process';
import * as stats from '@/lib/api-handlers/durable-exec/stats';
...
const routeTable: RouteEntry[] = [
  { segments: ["process"], paramNames: [], handlers: { POST: process.POST } },
