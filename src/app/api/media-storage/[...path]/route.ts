 ...
 * Catch-all route handler for /api/media-storage/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as capabilities from '@/lib/api-handlers/media-storage/capabilities';
import * as client_upload from '@/lib/api-handlers/media-storage/client_upload';
...
const routes: RouteEntry[] = [
  ...
  { segments: ["client-upload"], paramNames: [], handlers: { POST: client_upload.POST } },
];
