 ...
 * Catch-all route handler for /api/quotas/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as check from '@/lib/api-handlers/quotas/check';
import * as index from '@/lib/api-handlers/quotas/index';
...
const routes: RouteEntry[] = [
  { segments: ["check"], paramNames: [], handlers: { GET: check.GET } },
  { segments: [], paramNames: [], handlers: { GET: index.GET, PATCH: index.PATCH } },
];
