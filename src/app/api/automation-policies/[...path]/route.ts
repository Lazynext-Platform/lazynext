 ...
 * Catch-all route handler for /api/automation-policies/*
 * Consolidates 3 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as check from '@/lib/api-handlers/automation-policies/check';
import * as index from '@/lib/api-handlers/automation-policies/index';
import * as _id from '@/lib/api-handlers/automation-policies/_id';
