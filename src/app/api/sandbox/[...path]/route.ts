 ...
 * Catch-all route handler for /api/sandbox/*
 * Consolidates 3 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as runs from '@/lib/api-handlers/sandbox/runs';
import * as stats from '@/lib/api-handlers/sandbox/stats';
import * as runs___id from '@/lib/api-handlers/sandbox/runs___id';
...
const routes: RouteEntry[] = [
  ...
  { segments: ["runs","[id]"], paramNames: ["id"], handlers: { GET: runs___id.GET, POST: runs___id.POST } },
];
