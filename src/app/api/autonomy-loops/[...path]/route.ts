 ...
 * Catch-all route handler for /api/autonomy-loops/*
 * Consolidates 3 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as index from '@/lib/api-handlers/autonomy-loops/index';
import * as _id__iterate from '@/lib/api-handlers/autonomy-loops/_id__iterate';
import * as _id from '@/lib/api-handlers/autonomy-loops/_id';
...
const routes: RouteEntry[] = [
  ...
  { segments: ["[id]","iterate"], paramNames: ["id"], handlers: { POST: _id__iterate.POST } },
