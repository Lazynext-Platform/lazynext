...
export async function GET(req: NextRequest) {
  ...
  const vendors = await RelocationService.listVendors(organizationId, opts as never);
...
export async function POST(req: NextRequest) {
  ...
  try {
    const vendor = await RelocationService.createVendor(ws.organizationId, ws.id, {
    ...
    console.error('[relocation/vendors] create error:', e);
