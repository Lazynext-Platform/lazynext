 ...
 * Catch-all route handler for /api/integrations/*
 * Consolidates 3 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as health from '@/lib/api-handlers/integrations/health';
import * as index from '@/lib/api-handlers/integrations/index';
import * as _platform from '@/lib/api-handlers/integrations/_platform';
...
const routeTable: RouteEntry[] = [
  { segments: ["health"], paramNames: [], handlers: { GET: health.GET } },
  { segments: [], paramNames: [], handlers: { GET: index.GET, POST: index.POST } },
  { segments: ["[platform]"], paramNames: ["platform"], handlers: { GET: _platform.GET, POST: _platform.POST, DELETE: _platform.DELETE } },
];
