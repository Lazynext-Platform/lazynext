 ...
 * Catch-all route handler for /api/permission-checks/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as index from '@/lib/api-handlers/permission-checks/index';
import * as _id from '@/lib/api-handlers/permission-checks/_id';
