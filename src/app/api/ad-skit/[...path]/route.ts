 ...
 * Catch-all route handler for /api/ad-skit/*
 * Consolidates 3 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as image from '@/lib/api-handlers/ad-skit/image';
import * as plan from '@/lib/api-handlers/ad-skit/plan';
import * as video from '@/lib/api-handlers/ad-skit/video';
...
const routes: RouteEntry[] = [
  { segments: ["image"], paramNames: [], handlers: { POST: image.POST } },
  { segments: ["plan"], paramNames: [], handlers: { POST: plan.POST } },
  { segments: ["video"], paramNames: [], handlers: { POST: video.POST } },
];
