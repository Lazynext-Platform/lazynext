 ...
 * Catch-all route handler for /api/tools/*
 * Consolidates 3 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as seed from '@/lib/api-handlers/tools/seed';
import * as index from '@/lib/api-handlers/tools/index';
import * as _id from '@/lib/api-handlers/tools/_id';
