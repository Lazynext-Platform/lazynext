 ...
 * Catch-all route handler for /api/drama-studio/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as script from '@/lib/api-handlers/drama-studio/script';
import * as shot_image from '@/lib/api-handlers/drama-studio/shot_image';
...
const routeTable: RouteEntry[] = [
  { segments: ["script"], paramNames: [], handlers: { POST: script.POST } },
