 ...
 * Catch-all route handler for /api/mfa/*
 * Consolidates 3 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as disable from '@/lib/api-handlers/mfa/disable';
import * as setup from '@/lib/api-handlers/mfa/setup';
import * as verify from '@/lib/api-handlers/mfa/verify';
...
const routes: RouteEntry[] = [
  { segments: ["disable"], paramNames: [], handlers: { POST: disable.POST } },
  { segments: ["setup"], paramNames: [], handlers: { POST: setup.POST } },
  { segments: ["verify"], paramNames: [], handlers: { POST: verify.POST } },
];
