 ...
 * Catch-all route handler for /api/push/*
 * Consolidates 4 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as subscribe from '@/lib/api-handlers/push/subscribe';
import * as test from '@/lib/api-handlers/push/test';
import * as unsubscribe from '@/lib/api-handlers/push/unsubscribe';
import * as vapid_key from '@/lib/api-handlers/push/vapid_key';
...
const routeTable: RouteEntry[] = [
  { segments: ["subscribe"], paramNames: [], handlers: { POST: subscribe.POST } },
  { segments: ["test"], paramNames: [], handlers: { POST: test.POST } },
  { segments: ["unsubscribe"], paramNames: [], handlers: { POST: unsubscribe.POST } },
  { segments: ["vapid-key"], paramNames: [], handlers: { GET: vapid_key.GET } },
];
