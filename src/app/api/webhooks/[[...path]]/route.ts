 ...
 * Catch-all route handler for /api/webhooks/*
 * Consolidates 4 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as dispatch from '@/lib/api-handlers/webhooks/dispatch';
import * as rendobar from '@/lib/api-handlers/webhooks/rendobar';
import * as index from '@/lib/api-handlers/webhooks/index';
import * as stats___id from '@/lib/api-handlers/webhooks/stats___id';
...
const routeTable: RouteEntry[] = [
  ...
  { segments: ["rendobar"], paramNames: [], handlers: { POST: rendobar.POST } },
  { segments: [], paramNames: [], handlers: { GET: index.GET, POST: index.POST, PATCH: index.PATCH, DELETE: index.DELETE } },
  { segments: ["stats","[id]"], paramNames: ["id"], handlers: { GET: stats___id.GET } },
];
