 ...
 * Catch-all route handler for /api/creations/*
 * Consolidates 4 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as start from '@/lib/api-handlers/creations/start';
import * as index from '@/lib/api-handlers/creations/index';
import * as _id__assets from '@/lib/api-handlers/creations/_id__assets';
import * as _id from '@/lib/api-handlers/creations/_id';
...
const routeTable: RouteEntry[] = [
  ...
  { segments: ["[id]","assets"], paramNames: ["id"], handlers: { PATCH: _id__assets.PATCH } },
  { segments: ["[id]"], paramNames: ["id"], handlers: { GET: _id.GET, POST: _id.POST, DELETE: _id.DELETE } },
];
