 ...
 * Catch-all route handler for /api/creative-budget/*
 * Consolidates 2 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as check from '@/lib/api-handlers/creative-budget/check';
import * as summary from '@/lib/api-handlers/creative-budget/summary';
