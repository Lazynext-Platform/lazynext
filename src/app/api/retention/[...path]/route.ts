 ...
 * Catch-all route handler for /api/retention/*
 * Consolidates 3 routes into a single entry point.
 */
import { NextRequest, NextResponse } from 'next/server';
import * as run from '@/lib/api-handlers/retention/run';
import * as index from '@/lib/api-handlers/retention/index';
import * as _id from '@/lib/api-handlers/retention/_id';
